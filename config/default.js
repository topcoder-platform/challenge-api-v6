...
module.exports = {
  ...
  // TC AI M2M authentication
  TC_AI_M2M_AUTH0_CLIENT_ID: process.env.TC_AI_M2M_AUTH0_CLIENT_ID,
  TC_AI_M2M_AUTH0_CLIENT_SECRET: process.env.TC_AI_M2M_AUTH0_CLIENT_SECRET,
  TC_AI_M2M_AUTH0_URL: process.env.TC_AI_M2M_AUTH0_URL,
  TC_AI_M2M_AUTH0_AUDIENCE: process.env.TC_AI_M2M_AUTH0_AUDIENCE,
  TC_AI_M2M_AUTH_DOMAIN: process.env.TC_AI_M2M_AUTH_DOMAIN,
  TC_AI_M2M_AUTH_PROXY_SERVER_URL: process.env.TC_AI_M2M_AUTH_PROXY_SERVER_URL,
};
