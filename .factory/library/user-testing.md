...
- If future validation reuses round `17391`, remember that its initial create apply exited after challenge creation because legacy submission `-403380560001` (coder `22836077`) lacks numeric `submission_points`; this does not block targeted-rerun preserve validation but may matter for full provisional-score reconciliation.
